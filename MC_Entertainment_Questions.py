...
def Meerkeuzevragen_Entertainment():
    ...
    def Answer_a_Entertainment():
        cor = con.cursor()
        cor.execute("select answera from mc_questions where category = 'Entertainment' and questionID > 60 and questionID < 76")
        raws = cor.fetchall()
        for i in raws[questionID]:
           return(i)
    answer_choice_a = Answer_a_Entertainment()

    def Answer_b_Entertainment():
        cor = con.cursor()
        cor.execute("select answerb from mc_questions where category = 'Entertainment' and questionID > 60 and questionID < 76")
        raws = cor.fetchall()
        for i in raws[questionID]:
           return(i)
    answer_choice_b = Answer_b_Entertainment()

    def Answer_c_Entertainment():
        cor = con.cursor()
        cor.execute("select answerc from mc_questions where category = 'Entertainment' and questionID > 60 and questionID < 76")
        raws = cor.fetchall()
        for i in raws[questionID]:
           return(i)
    answer_choice_c = Answer_c_Entertainment()
    ...
    def mc_answers_Entertainment(name):
        cor = con.cursor()
        cor.execute("select correctanswer from mc_questions where category = 'Entertainment' and questionID > 60 and questionID < 76")
        raws = cor.fetchall()
            ...
            for evt in pygame.event.get():
                if evt.type == pygame.KEYDOWN:
                    ...
                    if evt.unicode.isalpha():
                        ...
                        check_answer = mc_answers_Entertainment(name)
