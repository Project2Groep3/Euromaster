...
def Meerkeuzevragen_Geografie():
    ...
    def Answer_a_Geografie():
        cor = con.cursor()
        cor.execute("select answera from mc_questions where category = 'Geografie' and questionID > 90 and questionID < 106")
        raws = cor.fetchall()
        for i in raws[questionID]:
           return(i)
    answer_choice_a = Answer_a_Geografie()

    def Answer_b_Geografie():
        cor = con.cursor()
        cor.execute("select answerb from mc_questions where category = 'Geografie' and questionID > 90 and questionID < 106")
        raws = cor.fetchall()
        for i in raws[questionID]:
           return(i)
    answer_choice_b = Answer_b_Geografie()

    def Answer_c_Geografie():
        cor = con.cursor()
        cor.execute("select answerc from mc_questions where category = 'Geografie' and questionID > 90 and questionID < 106")
        raws = cor.fetchall()
        for i in raws[questionID]:
           return(i)
    answer_choice_c = Answer_c_Geografie()
    ...
    def mc_answers_Geografie(name):
        cor = con.cursor()
        cor.execute("select correctanswer from mc_questions where category = 'Geografie' and questionID > 90 and questionID < 106")
        raws = cor.fetchall()
            ...
            for evt in pygame.event.get():
                ...
                if evt.type == pygame.KEYDOWN:
                    ...
                    if evt.key == pygame.K_9:
                        ...
                        check_answer = mc_answers_Geografie(name)
